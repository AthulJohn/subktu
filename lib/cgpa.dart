...
class _CgpaState extends State<Cgpa> {
  ...
  Widget schdropbutton1() {
    ...
    return DropdownButton(
      ...
      iconEnabledColor: Colors.black,
        hint: Text("Scheme",style: TextStyle(color: Colors.black),),
        items: schdrop1,
        value: schsel,
        onChanged: (value) {
          setState(() {
  ...
  Widget ad(int l, int se, int se2) {
    ...
    return Row(
      children: <Widget>[
        sel >= (se - 1) ? Expanded(child: Text("$k  YEAR")) : SizedBox(),
        SizedBox(
          width: 20,
        ),
        sel >= (se - 1)
            ? Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(hintText: "S $se"),
                  onChanged: (String z) {
                    setState(() {
                      if(z==''){
                        z="0";
        ...
        sel >= (se2 - 1)
            ? (Expanded(
                child: TextField(
                  keyboardType: TextInputType.number,
                  decoration: InputDecoration(hintText: "S $se2"),
                  onChanged: (String z) {
                    setState(() {
                      if(z==''){
                        z="0";
       ...
       // color: Colors.blue,
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              Row(
                children: <Widget>[
                  ...
                  DropdownButton(
                    iconEnabledColor: Colors.black,
                    hint: Text("Semester",style: TextStyle(color: Colors.black),),
                    value: sel,
                    items: listdrop,
                    onChanged: (value) {
                      setState(() {
            ...
            gggg>0 && schsel==0 ? Row(
                children: <Widget>[
                  Expanded(child: Text("Select sem which had graphics")),
                  Radio(
              ...
              gggg>0 && yyyy>0 ? Row(
               children: <Widget>[
                 Text("Enter SGPA of each sem in the textbox",style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),textAlign: TextAlign.left,),
               ],
             )
             :SizedBox(),
            Expanded(
